"""
import_real_data.py - Importa el dataset real de producci├│n a SQLite
y reconstruye socios, cr├⌐ditos, pagos y transacciones con historiales realistas.
"""
...
AGENCIAS = {
    20: "Agencia Tulc├ín (Matriz)",
    48: "Agencia Tulc├ín (Matriz)", # Consolida con la 20 para darle la mayor├¡a absoluta (~7,600+ socios)
    ...
    69: "Agencia El ├üngel",       # ~2,000+ socios
    ...
    118: "Agencia Sangolqu├¡",     # ~1,000+ socios
...
def main():
    ...
    # 3. Extraer y poblar Socios (├Ünicos)
    print("\n[DB] Poblando tabla 'socios'...")
    # Agrupar por cliente para obtener info ├║nica de cada socio
    ...
    for _, row in df.iterrows():
        ...
        # Estimar cuota mensual: Amortizaci├│n lineal + inter├⌐s estimado
    ...
    for i, row in df.iterrows():
        ...
        # Determinar cu├íntos meses han pasado desde el desembolso
        ...
        for cuota_idx in range(1, elapsed_months + 1):
            ...
            # Determinar si esta cuota est├í en mora
            ...
            if is_overdue:
                ...
                estado_pago = "Pagado"
                # Peque├▒a variaci├│n realista en fecha de pago
        ...
        # Insertar en lotes peri├│dicamente para optimizar memoria
